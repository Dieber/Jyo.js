(function (window, document, Jyo, undefined) {
    ...
    // 旋转矩阵
    Jyo.Matrix.createRotation = Jyo.overload().
                                               add("Jyo.Vector3", function (vec3) {
                                                   return Jyo.Matrix.createRotation(vec3.x, vec3.y, vec3.z);
                                               }).
                                               add("Number, Number, Number", function (radiansX, radiansY, radiansZ) {
                                                   /// <summary>创建旋转的矩阵</summary>
                                                   /// <param name="radiansX" type="Number">绕X轴弧度</param>
                                                   /// <param name="radiansY" type="Number">绕Y轴弧度</param>
                                                   /// <param name="radiansZ" type="Number">绕Z轴弧度</param>
                                                   /// <returns type="Jyo.Matrix" />

                                                   return Jyo.Matrix.createRotateX(radiansX).
                                                       multiply(Jyo.Matrix.createRotateY(radiansY)).
                                                       multiply(Jyo.Matrix.createRotateZ(radiansX));
                                               });
    ...
    Jyo.Matrix.prototype = {
        add: Jyo.overload().
                add("Jyo.Matrix", function (matrix) {
                    /// <summary>与另一矩阵相加并返回新矩阵</summary>
                    /// <param name="matrix" type="Jyo.Matrix">矩阵</param>    
                    /// <returns type="Jyo.Matrix" />

                    var result = new Jyo.Matrix();
                    Jyo.Matrix.add(this, matrix, result);
                    return result;
                }),
        subtract: Jyo.overload().
                add("Jyo.Matrix", function (matrix) {
                    /// <summary>与另一矩阵相减并返回新矩阵</summary>
                    /// <param name="matrix" type="Jyo.Matrix">矩阵</param>    
                    /// <returns type="Jyo.Matrix" />

                    var result = new Jyo.Matrix();
                    Jyo.Matrix.subtract(this, matrix, result);
                    return result;
                }),
        multiply: Jyo.overload().
                      add("Jyo.Matrix", function (matrix) {
                          /// <summary>与另一矩阵相乘并返回新矩阵</summary>
                          /// <param name="matrix" type="Jyo.Matrix">矩阵</param>    
                          /// <returns type="Jyo.Matrix" />

                          var result = new Jyo.Matrix();
                          Jyo.Matrix.multiply(this, matrix, result);
                          return result;
                      }).
                      add("Number", function (value) {
                          /// <summary>与一个标量值相乘并返回新矩阵</summary>
                          /// <param name="matrix" type="Jyo.Matrix">矩阵</param>    
                          /// <returns type="Jyo.Matrix" />

                          var result = new Jyo.Matrix();
                          Jyo.Matrix.multiply(this, value, result);
                          return result;
                      }),
        divide: Jyo.overload().
                      add("Jyo.Matrix", function (matrix) {
                          /// <summary>除以另一矩阵并返回新矩阵</summary>
                          /// <param name="matrix" type="Jyo.Matrix">矩阵</param>    
                          /// <returns type="Jyo.Matrix" />

                          var result = new Jyo.Matrix();
                          Jyo.Matrix.divide(this, matrix, result);
                          return result;
                      }).
                      add("Number", function (value) {
                          /// <summary>除以一个标量值并返回新矩阵</summary>
                          /// <param name="matrix" type="Jyo.Matrix">矩阵</param>    
                          /// <returns type="Jyo.Matrix" />

                          var result = new Jyo.Matrix();
                          Jyo.Matrix.divide(this, value, result);
                          return result;
                      }),
        inverse: function () {
            /// <summary>逆反矩阵并返回新矩阵</summary>
            /// <returns type="Jyo.Matrix" />

            return Jyo.Matrix.inverse(this);
        },
        to44Array: function () {
