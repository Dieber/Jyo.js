(function (window, document, Jyo, undefined) {
    ...
    Jyo.Vector3.normalize = Jyo.overload().
            ...
            var factor = Jyo.Vector3.distance(value, Jyo.Vector3.zero);
            factor = 1 / factor;
    ...
    Jyo.Vector3.transformCoordinates = function (vec3, transformation) {
    ...
    Jyo.Vector3.prototype = {
        subtract: Jyo.overload().
                      add("Number", function (value) {
                       /// <summary>减去一个标量值并返回新向量</summary>

                       var result = new Jyo.Vector3();
                       Jyo.Vector3.subtract(this, value, result);
                       return result;
                   }).
                      add("Jyo.Vector3", function (point) {
                /// <summary>减去另一个向量并返回新向量</summary>

                var result = new Jyo.Vector3();
                Jyo.Vector3.subtract(this, point, result);
                return result;
            }),
        add: Jyo.overload().
                add("Number", function (value) {
                                   /// <summary>加上一个标量值并返回新向量</summary>

                                   var result = new Jyo.Vector3();
                                   Jyo.Vector3.add(this, value, result);
                                   return result;
                               }).
                add("Jyo.Vector3", function (point) {
                /// <summary>加上另一个向量并返回新向量</summary>

                var result = new Jyo.Vector3();
                Jyo.Vector3.add(this, point, result);
                return result;
            }),
        multiply: Jyo.overload().
                      add("Number", function (value) {
                                   /// <summary>乘以一个标量值并返回新向量</summary>

                                   var result = new Jyo.Vector3();
                                   Jyo.Vector3.multiply(this, value, result);
                                   return result;
                               }).
                      add("Jyo.Vector3", function (point) {
                /// <summary>乘以另一个向量并返回新向量</summary>

                var result = new Jyo.Vector3();
                Jyo.Vector3.multiply(this, point, result);
                return result;
            }),
        divide: Jyo.overload().
                   add("Number", function (value) {
                                   /// <summary>除以一个标量值并返回新向量</summary>

                                   var result = new Jyo.Vector3();
                                   Jyo.Vector3.divide(this, value, result);
                                   return result;
                               }).
                   add("Jyo.Vector3", function (point) {
                /// <summary>除以另一个向量并返回新向量</summary>

                var result = new Jyo.Vector3();
                Jyo.Vector3.divide(this, point, result);
                return result;
            }),
        ...
        length: function () {
            ...
            var result = Jyo.Vector3.distanceSquared(this, Jyo.Vector3.zero);
    ...
    Object.defineProperty(Jyo.Vector3, "zero", {
        get: function () {
            /// <summary>全0向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "one", {
        get: function () {
            /// <summary>全1向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "unitX", {
        get: function () {
            /// <summary>X为1向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "unitY", {
        get: function () {
            /// <summary>Y为1向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "unitZ", {
        get: function () {
            /// <summary>Z为1向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "up", {
        get: function () {
            /// <summary>上方向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "down", {
        get: function () {
            /// <summary>下方向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "right", {
        get: function () {
            /// <summary>右方向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "left", {
        get: function () {
            /// <summary>左方向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "forward", {
        get: function () {
            /// <summary>前方向量实例</summary>
            /// <returns type="Jyo.Vector3" />
    ...
    Object.defineProperty(Jyo.Vector3, "backward", {
        get: function () {
            /// <summary>后方向量实例</summary>
            /// <returns type="Jyo.Vector3" />
